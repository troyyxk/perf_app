...
rtt_1000 = sum(test_tput( 10, 1000, my_server_delay))/10
rtt_2000 = sum(test_tput( 10, 2000, my_server_delay))/10
rtt_4000 = sum(test_tput( 10, 4000, my_server_delay))/10
rtt_8000 = sum(test_tput( 10, 8000, my_server_delay))/10
rtt_16000 = sum(test_tput( 10, 16000, my_server_delay))/10
rtt_32000 = sum(test_tput( 10, 32000, my_server_delay))/10

throughput_x = [1000, 2000, 4000, 8000, 16000, 32000]
throughput_y = [1000/rtt_1000,
 2000/rtt_2000,
 4000/rtt_4000,
 8000/rtt_8000,
 16000/rtt_16000,
